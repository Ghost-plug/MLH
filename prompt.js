...
function checkName() {
  ...
  if (input === correctName.toLowerCase()) {
    ...
    out of life. Happy Birthday My little heaven, Happy birthday my lost heaven. If there is still a chance we might, God, there's things I want to say to you but I'll just let you live.😊 I love you guy! omo`;
